    ...
    <main className="flex flex-1 flex-col bg-zinc-950 text-zinc-100">
      <section className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center px-4 py-16">
        <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl">
          Peer<span className="text-emerald-400">Bridge</span>
        </h1>
        ...
        <div className="mt-10 w-full max-w-md">
            ...
            <>
              ...
              >
                <input
                  ...
                  placeholder="ABC123"
                  maxLength={6}
                  className="flex-1 rounded-lg border border-zinc-800 bg-zinc-900 px-4 py-2.5 text-center font-mono uppercase tracking-widest text-zinc-100 outline-none focus:border-cyan-400"
                />
                <button
                  type="submit"
                  className="flex items-center gap-1 rounded-lg bg-emerald-400 px-4 py-2.5 text-sm font-semibold text-zinc-950 transition-opacity hover:opacity-90"
                >
          ...
          {file && roomId && (
            <div className="flex flex-col items-center gap-6">
              <div className="flex w-full items-center justify-between rounded-xl border border-zinc-800 bg-zinc-900/60 px-4 py-3">
                ...
                <button onClick={reset} className="shrink-0 text-zinc-500 hover:text-zinc-200">
              ...
              {status === "completed" && completed === null && (
                <p className="text-sm text-emerald-400">Transfer complete.</p>
              )}
